...
class GraphVals:
	...
	print _neutral
	self.q = spl.spline(X, _cation[0], _cation[1], _neutral[0], _neutral[1])
	self.diffi = integrate.quad(spl.diffi, 0, 1, args=(_cation[0], _cation[1], _neutral[0], _neutral[1]))[0]
	self.iGraph = spl.diffi(X, _cation[0], _cation[1], _neutral[0], _neutral[1])
	print spl.spline(1, _cation[0], _cation[1], _neutral[0], _neutral[1])
        print spl.spline(0, _cation[0], _cation[1], _neutral[0], _neutral[1])
