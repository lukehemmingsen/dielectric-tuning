...
def new_files(con, HFcon, B3con, BHHcon, filename):
    ...
    os.system("qchem " + nm + ".in > " + nm + ".out")
    os.system("qchem " + nm + "a.in > " + nm + "a.out")
    os.system("qchem " + nm + "HF.in > " + nm + "HF.out")
    os.system("qchem " + nm + "HFa.in > " + nm + "HFa.out")
    os.system("qchem " + nm + "B3LYP.in > " + nm + "B3LYP.out")
    os.system("qchem " + nm + "B3LYPa.in > " + nm + "B3LYPa.out")
    os.system("qchem " + nm + "BHHLYP.in > " + nm + "BHHLYP.out")
    os.system("qchem " + nm + "BHHLYPa.in > " + nm + "BHHLYPa.out")
