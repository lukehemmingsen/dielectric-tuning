...
def new_files(con, HFcon, B3con, BHHcon, filename):
    ...
    os.system("qchem " + nm + "a0.in > " + nm + "a.out")
    os.system("qchem " + nm + "HF0.in > " + nm + "HF.out")
    os.system("qchem " + nm + "HFa0.in > " + nm + "HFa.out")
    os.system("qchem " + nm + "B3LYP0.in > " + nm + "B3LYP.out")
    os.system("qchem " + nm + "B3LYPa0.in > " + nm + "B3LYPa.out")
    os.system("qchem " + nm + "BHHLYP0.in > " + nm + "BHHLYP.out")
    os.system("qchem " + nm + "BHHLYPa0.in > " + nm + "BHHLYPa.out")
...
class GraphVals:
	...
	print _neutral	
	self.q = spl.spline(X, _anion[0], _anion[1], _neutral[0], _neutral[1])
	self.diffi = integrate.quad(spl.diffi, 0, 1, args=(_anion[0], _anion[1], _neutral[0], _neutral[1]))[0]
